...
namespace Player
{
    ...
    public class PlayerStatusManager : PlayerBase
    {
        ...
        {
            get => _curPlayerHealth;
            private set => _curPlayerHealth = value;
        }

        public float CurPlayerArmor
        {
            get => _curPlayerArmor;
            private set => _curPlayerArmor = value;
        }

        public float CurPlayerEnergy
        {
            get => _curPlayerEnergy;
            private set => _curPlayerEnergy = value;
        }
