...
namespace NPC.Enemy
{
    public class EnemySpawnController : MonoBehaviour
    {
        ...
        [Tooltip("Put 1+ enemy prefabs here. If multiple, a random one is chosen each spawn.")]
        public List<GameObject> enemyPrefabs = new List<GameObject>();

        [Header("Where to spawn")] [Tooltip("Potential spawn locations. The spawner picks a random one each wave.")]
        public List<Transform> spawnPoints = new List<Transform>();

        [Header("Wave settings")] [Min(1)] public int maxEnemiesPerWave = 5;
        ...
        [Header("Optional: Lightweight Pool")] public bool usePooling = true;
        [Min(0)] public int poolSize = 25;
