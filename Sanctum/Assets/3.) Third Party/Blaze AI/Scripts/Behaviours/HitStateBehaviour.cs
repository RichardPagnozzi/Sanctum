...
namespace BlazeAISpace
{
    public class HitStateBehaviour : MonoBehaviour
    {
        ...
        void CallOthers()
        {
            ...
            int agentsCollNum = Physics.OverlapSphereNonAlloc(transform.position + blaze.centerPosition,
                callOthersRadius, agentsColl, agentLayersToCall);
